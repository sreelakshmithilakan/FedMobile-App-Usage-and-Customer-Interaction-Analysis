...
--   FLOOR(18 + RAND()*18),                                   -- Random age between 18 and 35
--   ELT(FLOOR(1+RAND()*6),
...
--     SUM(monetary_events >= 1) AS users_with_first_transaction,
--     SUM(monetary_events >= 2) AS users_with_repeat_transaction
-- FROM user_activity;
...
-- SELECT
--     DATE_FORMAT(c.created_at,'%Y-%m') AS signup_month,
